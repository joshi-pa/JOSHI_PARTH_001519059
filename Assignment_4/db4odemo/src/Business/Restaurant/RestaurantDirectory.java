...
public class RestaurantDirectory {
    ...
    public Restaurant newRestaurant(String name, String address, String restroMName, String phoneNumber, String restRating) {
        Restaurant restaurant = new Restaurant(name, address, restroMName, phoneNumber, restRating);
